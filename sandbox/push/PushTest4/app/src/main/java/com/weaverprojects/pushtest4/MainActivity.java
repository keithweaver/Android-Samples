package com.weaverprojects.pushtest4;
...
public class MainActivity extends Activity implements View.OnClickListener
{
    ...
    public static final String GCM_SENDER_ID = "485791388361";
    public static String PREFS_PROPERTY_REG_ID = "registration_id";
...
//        }
    ...
    public void onClick(View v)
    {
        ...
        switch (v.getId())
        {
            case R.id.register_button:
                ...
                {
                    Log.i("WEAVER:", "No valid Google Play Services APK found.");
                }
                break;
        ...
        new AsyncTask<String, Void, String>()
        {
            ...
            protected String doInBackground(String... params)
            {
                ...
                try
                {
                    ...
                    gcm.send(params[0], id, GCM_TIME_TO_LIVE, data);
    ...
    private boolean checkPlayServices()
    {
        ...
        if (resultCode != ConnectionResult.SUCCESS)
        {
            ...
            {
                Log.i("WEAVER:", "This device is not supported.");
                finish();
            }
            return false;
        }
    ...
    private String getRegistrationId(Context context)
    {
        ...
        {
            Log.i("WEAVER:", "Registration not found.");
            return "";
        }
        ...
        {
            Log.i("WEAVER:", "App version changed.");
            return "";
        }
    ...
    private void storeRegistrationId(Context context, String regId)
    {
        ...
        Log.i("WEAVER:", "Saving regId on app version " + appVersion);
    ...
    private void removeRegistrationId(Context context)
    {
        final SharedPreferences prefs = getGcmPreferences(context);
        int appVersion = getAppVersion(context);
        Log.i("WEAVER:", "Removig regId on app version " + appVersion);
        SharedPreferences.Editor editor = prefs.edit();
    ...
    {
        Log.d("WEAVER:", "REGISTER USERID: " + regid);
    ...
    {
        Log.d("WEAVER:", "UNREGISTER USERID: " + regid);
        new AsyncTask<Void, Void, String>()
        {
            @Override
            protected String doInBackground(Void... params)

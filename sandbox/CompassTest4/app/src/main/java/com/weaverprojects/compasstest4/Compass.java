...
public class Compass implements SensorEventListener {
    ...
    private void adjustArrow() {
        ...
        if(MainActivity.current_location != null) {
            ...
            Log.v("ROTATION ANGLE:", String.valueOf(angle));
            Log.v("AZIMUTH:", String.valueOf(azimuth));

            float angleFloat = (float) angle;

            float result = azimuth + angleFloat;
            Log.v("THE FINAL ANGLE:", String.valueOf(result));

            float pastResult = currentRotationAngle + currectAzimuth;
            //----------------

            Animation an = new RotateAnimation(-pastResult, -result,
                    Animation.RELATIVE_TO_SELF, 0.5f, Animation.RELATIVE_TO_SELF,
                    0.5f);
            currectAzimuth = azimuth;
            currentRotationAngle = angleFloat;

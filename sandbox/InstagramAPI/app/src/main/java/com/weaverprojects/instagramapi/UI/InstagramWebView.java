 ...
 */
public class InstagramWebView extends Dialog {
    ...
    public InstagramWebView(Context context, String url,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.v(TAG, "OnCreate for WebView");
